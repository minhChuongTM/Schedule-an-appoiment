      ...
      <section className="container my-5">
        <div className="row">
          ...
          <div className="col-lg-8">
            <h2>Dịch vụ tư vấn thuốc</h2>
            <p>
              Dịch vụ tư vấn thuốc giúp người bệnh hiểu rõ cách sử dụng thuốc an
              toàn, đúng liều, hạn chế tác dụng phụ và tương tác thuốc.
            </p>
          </div>
