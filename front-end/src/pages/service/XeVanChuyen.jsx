      ...
      <section className="container my-5">
        <div className="row">
          ...
          <div className="col-lg-8">
            <h2>Dịch vụ xe vận chuyển</h2>
            <p>
              Dịch vụ xe vận chuyển của Bệnh viện Anh Hùng hỗ trợ đưa đón người
              bệnh an toàn, đúng giờ, phù hợp với tình trạng sức khỏe.
            </p>
          </div>
