...
function ChuyenPhat() {
  ...
  return (
    <>
      <HospitalBanner
        parentLabel="Dịch vụ"
        currentLabel="Chuyển phát nhanh"
      ...
      <section className="container my-5">
        <div className="row">
          ...
          <div className="col-lg-8">
            <h2>Dịch vụ chuyển phát nhanh</h2>
            <p>
              Bệnh viện Anh Hùng cung cấp dịch vụ chuyển phát nhanh các loại hồ sơ
              y tế, giấy tờ hành chính và viện phí nhằm tiết kiệm thời gian cho
